...
const Footer = () => {
    return (
        <div className="w-full ">
            ...
            <div className="h-[300px] bg-gray-900 flex items-center justify-center text-white text-[13px]">
                <div className="w-main flex">
                    <div className="flex-2 flex flex-col gap-2">
                        <h3 className="mb-[20px] text-[15px] font-medium border-l-4 border-main pl-[15px]">ABOUT US</h3>
                        <span>
                            <span>Address: </span>
                            <span className="opacity-70">298 Cau Dien Street, Bac Tu Liem District, Hanoi</span>
                        </span>
                        <span>
                            <span>Phone: </span>
                            <span className="opacity-70">(+84)365892986</span>
                        </span>
                        <span>
                            <span>Mail: </span>
                            <span className="opacity-70">hoangchung.work@gmail.com</span>
                        </span>
                    </div>
